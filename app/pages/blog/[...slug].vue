<template>
  <div class="w-full max-w-4xl mx-auto">
    ...
    <!-- 右下角悬浮返回按钮 -->
    <NuxtLink to="/blog" class="fixed bottom-8 right-8 z-[90] flex items-center justify-center w-14 h-14 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group" title="返回博客">
